...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "Agent":
			resolverName, err := entityResolverNameForAgent(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Agent": %w`, err)
			}
			switch resolverName {
			...
			case "findAgentByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findAgentByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindAgentByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Agent": %w`, err)
				}
...
func entityResolverNameForAgent(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
